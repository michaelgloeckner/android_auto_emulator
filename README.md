...
docker build -t michaelgloeckner4/android-automotive-emulator:latest .
docker rm android-automotive-emulator
docker run -idt --device /dev/kvm --name android-automotive-emulator -p 5555:5555 -p 8080:8080 -e DISPLAY_WIDTH=1600 -e DISPLAY_HEIGHT=968 michaelgloeckner4/android-automotive-emulator:latest
